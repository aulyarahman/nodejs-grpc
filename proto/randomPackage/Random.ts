...
export interface RandomClient extends grpc.Client {
  PingPong(argument: _randomPackage_PingRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: (error?: grpc.ServiceError, result?: _randomPackage_PingResponse__Output) => void): grpc.ClientUnaryCall;
  PingPong(argument: _randomPackage_PingRequest, metadata: grpc.Metadata, callback: (error?: grpc.ServiceError, result?: _randomPackage_PingResponse__Output) => void): grpc.ClientUnaryCall;
  PingPong(argument: _randomPackage_PingRequest, options: grpc.CallOptions, callback: (error?: grpc.ServiceError, result?: _randomPackage_PingResponse__Output) => void): grpc.ClientUnaryCall;
  PingPong(argument: _randomPackage_PingRequest, callback: (error?: grpc.ServiceError, result?: _randomPackage_PingResponse__Output) => void): grpc.ClientUnaryCall;
  pingPong(argument: _randomPackage_PingRequest, metadata: grpc.Metadata, options: grpc.CallOptions, callback: (error?: grpc.ServiceError, result?: _randomPackage_PingResponse__Output) => void): grpc.ClientUnaryCall;
  pingPong(argument: _randomPackage_PingRequest, metadata: grpc.Metadata, callback: (error?: grpc.ServiceError, result?: _randomPackage_PingResponse__Output) => void): grpc.ClientUnaryCall;
  pingPong(argument: _randomPackage_PingRequest, options: grpc.CallOptions, callback: (error?: grpc.ServiceError, result?: _randomPackage_PingResponse__Output) => void): grpc.ClientUnaryCall;
  pingPong(argument: _randomPackage_PingRequest, callback: (error?: grpc.ServiceError, result?: _randomPackage_PingResponse__Output) => void): grpc.ClientUnaryCall;
